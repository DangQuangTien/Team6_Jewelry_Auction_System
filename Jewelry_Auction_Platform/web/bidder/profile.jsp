...
<html lang="en">
    <head>
        ...
        <style>
            ...
            /* Improved Date of Birth styling */
            .dob-container {
                display: flex;
                justify-content: space-between;
                gap: 5px;
        ...
        <script>
            function validateForm() {
                ...
                var day = document.forms["profileForm"]["day"].value;
                var month = document.forms["profileForm"]["month"].value;
                var year = document.forms["profileForm"]["year"].value;
                if (day === "" || month === "" || year === "") {
    ...
    <body>
        ...
        <nav>
            <div>
                ...
                <a
                    href="${pageContext.request.contextPath}/auctions">Auctions</a>
                <a
                    href="${pageContext.request.contextPath}/valuation">Selling</a>
                <a href="${pageContext.request.contextPath}/my-upcoming-bids">My
                    Bids</a>
                <a href="${pageContext.request.contextPath}/response">My
                    Asset</a>
            </div>
                ...
                <form name="profileForm"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="gender"
                                    ...
                                    <option value="Male" ${member.gender ==
                                        'Male' ? 'selected' : ''}>Male</option>
                                    <option value="Female" ${member.gender ==
                                        'Female' ? 'selected' :
                                        ''}>Female</option>
                                    <option value="Other" ${member.gender ==
                                        'Other' ? 'selected' :
                                        ''}>Other</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="dob-container">
                                    ...
                                    <select class="form-control" id="year"
                                        ...
                                        <c:foreach var="i" begin="1900"
                                            end="${now.year}">
                                            <option value="${i}" ${member.year
                                                == i ? 'selected' :
                                                ''}>${i}</option>
                                        </c:foreach>
                                    </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <button type="submit" class="btn-update">Update
                                Profile</button>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="holderName"
                                    class="form-label">Holder Name</label>
                                <input type="text" class="form-control"
                                    id="holderName" name="holderName"
                                    value="${card.holderName}" readonly>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    ...
                                    value="${card.cardNumber}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="cvvCode" class="form-label">CVV
                                    Code</label>
                                <input type="text" class="form-control"
                                    id="cvvCode" name="cvvCode"
                                    value="${card.cvvCode}" readonly>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    ...
                                    value="${card.expiryDate}" readonly>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <footer
            style="background-color: #000407; font-family: Helvetica; height: 30px; position: fixed; bottom: 0; width: 100%; text-align: center;">
            <span style="color: lightgrey; font-size: 14px;">&#169; F'RANKELLY
                AUCTION
